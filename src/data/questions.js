...
export const QUESTIONS_DATA = [
  ...
  // ── US EQUITIES (3) ────────────────────────────────────────
  {
    ...
    bullets: [
      ...
      "<strong>Our view: selectivity over broad beta.</strong> We see opportunity in AI-exposed names, reshoring beneficiaries, and sectors levered to the capex cycle — industrials, materials, and companies where AI buildout is driving earnings upside."
    ],
    tickers: ["BLCR", "QUAL"],
    placeholderChart: {
      type: "bar",
